...
Sigmatrue=ar1_cor(p,0.95) # true covariance matrix
...
for(rep in 1:replication_time){
  ...
  result=c(error1,error3,error5,error6,error7,error8)
  result_error=rbind(result,result_error)
}

colnames(result_error)=c("OUR","NO-GROUP","G-LASSO",
                         "TIGER","CLIME","POET")
print(result_error)
...
for(rep in 1:replication_time){
  ...
  result=c(error1,error3,error4,error5,error6,error7,error8)
  result_error=rbind(result,result_error)
}

colnames(result_error)=c("OUR","NO-GROUP","SAMPLE","G-LASSO",
                         "TIGER","CLIME","POET")
print(result_error)
