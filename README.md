...
1. main.R will sequentially runs each section of the analyses presented in the paper, generating the figures and tables as they appear in the text.
...
3. For a file named "Source_TableX.R" and "Source_FigureX.R", it will be loaded by "main.R" to generate the corresponding tables and figures.
